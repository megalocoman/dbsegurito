...
CREATE TABLE accidente (
    ...
    clienterutcliente  INTEGER NOT NULL
);
...
ALTER TABLE actividades ADD CONSTRAINT actividades_pk PRIMARY KEY ( codigoactividad );
...
CREATE TABLE ot (
    ...
    statusactividad               VARCHAR2(50 CHAR) NOT NULL,
...
CREATE TABLE profesional (
    rutprofesional  INTEGER NOT NULL,
    nombre          VARCHAR2(150 CHAR) NOT NULL,
    telefono        INTEGER,
    correo          VARCHAR2(100 CHAR)
);

ALTER TABLE profesional ADD CONSTRAINT profesional_pk PRIMARY KEY ( rutprofesional );

ALTER TABLE accidente
    ADD CONSTRAINT accidente_cliente_fk FOREIGN KEY ( clienterutcliente )
...
ALTER TABLE ot
    ADD CONSTRAINT ot_actividades_fk FOREIGN KEY ( actividades_codigo_actividad )
        REFERENCES actividades ( codigoactividad );
